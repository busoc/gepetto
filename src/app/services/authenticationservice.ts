export class AuthenticationService {
	// // constants
	// static clientId = '941889093811-h4gqit2jjfc9d9n3cq4ubifgd4l3cpt4.apps.googleusercontent.com';
	// static apiKey = 't9Tc1MLbH-uQQZvHtj9Z35jm'; // or: "nXImuKGaTLUAANCSxSba9_jT"
	// static scopes = ['https://www.googleapis.com/auth/plus.login https://www.googleapis.com/auth/userinfo.email'];
